...
class MathIdevice(Idevice):
    ...
    def __init__(self, instruc="", latex=""):
        Idevice.__init__(self, x_("Maths"),
        ...
        self.content = MathField(x_("Maths"), x_(
    ...
    def convertToFreeText(self):
        ...
        if self.content.gifResource is not None:
        ...
        if imageResource_exists:
            ...
            new_GalleryImage = GalleryImage(
                replacementIdev.content, '', full_image_path, mkThumbnail=False)
            ...
            new_GalleryLatex = GalleryImage(
                replacementIdev.content,
                '',
                math_filename_str,
                mkThumbnail=False)
