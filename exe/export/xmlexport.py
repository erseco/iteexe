...
class XMLExport(WebsiteExport):
    ...
    def export(self, package):
        ...
        if self.langOverride is not None:
        ...
        for currentProfile in profileList:
            ...
            pageDevCount = thisPage.save(
                currentOutputDir, prevPage, None, self.pages, nonDevices)
            numDevicesByPage[thisPage.name] = pageDevCount
            ...
            for idevice in page.node.idevices:
                ...
                if idevice.__class__.__name__ in nonDevices:
                    ...
                    ideviceLine = "\t<idevice id='%(ideviceid)s' title='%(title)s'/>\n" % {
                        ...
                        "title": XMLExport.encodeEntities(
                            idevice.get_title())}
