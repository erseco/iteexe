...
class ParasabermasfpdIdevice(Idevice):
    ...
    def __init__(self, activity="", answer=""):
        ...
        Idevice.__init__(
            ...
            x_("""A Step Ahead is an iDevice that permits students widen their knowledge with further contents."""),
            "",
            "parasabermasfpd")
...
#        self.systemResources += ["common.js"]
    ...
    def upgradeToVersion7(self):
        ...
        self.activityTextArea = TextAreaField(
            x_('A Step Ahead Text'), self._activityInstruc, self.activity)
        self.activityTextArea.idevice = self
