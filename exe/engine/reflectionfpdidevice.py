...
class ReflectionfpdIdevice(Idevice):
    ...
    def __init__(self, activity="", answer=""):
        ...
        Idevice.__init__(self,
                         x_("FPD - Think About It (with Feedback)"),
...
#        self.emphasis         = Idevice.SomeEmphasis
    ...
    def upgradeToVersion9(self):
        if self._title == "FPD - Reflexiona (con Retroalimentacion)":
            self._title = "FPD - Think About It (with Feedback)"
        if self._title == "Reflexiona (con Retroalimentacion)":
