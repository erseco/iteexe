...
class HangmanIdeviceInc(Idevice):
    ...
    def __init__(self, content=""):
        ...
        self.alphabet = TextField(
            x_("Alphabet to Select From"),
            x_("Alphabet to show players"),
        ...
        self.letterButtonStyle = TextField(
            x_("Letter Button Style"),
            x_("Style of button to start with"),
            "color: white; background-color: blue;")
        self.letterButtonStyle.idevice = self

        self.wrongLetterButtonStyle = TextField(
            x_("Letter Button Style Wrong Guess"),
            x_("Style of letter button after wrong guess"),
            "color: white; background-color: red;")
        self.wrongLetterButtonStyle.idevice = self

        self.rightLetterButtonStyle = TextField(
            x_("Letter Button Style Right Guess"),
            x_("Style of letter button after correct guess"),
            "color: white; background-color : green;")
        self.rightLetterButtonStyle.idevice = self

        self.hintFieldStyle = TextField(
            x_("Style of Hint Text Field"),
            x_("Hint Text Field CSS"))
        self.hintFieldStyle.idevice = self

        self.wordAreaStyle = TextField(
            x_("Style of Word Display Field"),
            x_("Word Display CSS"))
        self.wordAreaStyle.idevice = self

        self.resetButtonText = TextField(
            x_("Restart Level Button Text"),
            x_("Text for reset button"),
            x_("Restart"))
        self.resetButtonText.idevice = self

        self.resetButtonStyle = TextField(
            x_("Restart Level Button Style (CSS)"),
            x_("Style of Reset Button"),
            "background-color: blue; color: white;")
        self.resetButtonStyle.idevice = self

    def _initNewAlerts(self):
        self.wrongGuessMessageField = TextAreaField(x_("Wrong Guess Message"), x_(
            "Player will see this message when they guess a letter wrong"), "")
        self.wrongGuessMessageField.idevice = self
        self.lostLevelMessageField = TextAreaField(x_("Lost Level Message"), x_(
            "Player will see this message when they loose the level"), "")
        self.lostLevelMessageField.idevice = self
        self.levelPasssedMessageField = TextAreaField(x_("Level Passed Message"), x_(
            "Player will see this message when they guess the word correctly"), "")
        self.levelPasssedMessageField.idevice = self
        self.gameWonMessageField = TextAreaField(x_("Game Won Message"), x_(
            "Player will see this message when they guess all words correctly"), "")
    ...
    def addWord(self):
        newWordTextField = TextField(
            x_("Word to Guess"), x_("Word To Guess"), "")
        newWordTextField.idevice = self
        newWordHintField = TextField(
            x_("Hint to Show User"), x_("Hint for Word"), "")
    ...
    def upgradeToVersion2(self):
        self.lostLevelMessageField = TextAreaField(
            x_("Lost Level Message"),
            x_("Player will see this message when they loose the level"),
            "<img src='smallcross.png'/>")
        self.lostLevelMessageField.idevice = self

        self.levelPasssedMessageField = TextAreaField(
            x_("Level Passed Message"),
            x_("Player will see this message when they guess the word correctly"),
            "<img src='smallcheck.png'/>")
        self.levelPasssedMessageField.idevice = self

        self.gameWonMessageField = TextAreaField(
            x_("Game Won Message"),
            x_("Player will see this message when they guess all words correctly"),
            "<img src='smallcheck.png'/>")
        self.gameWonMessageField.idevice = self

        self.wrongGuessMessageField = TextAreaField(
            x_("Wrong Guess Message"),
