...
class ClickInOrderBlockInc(Block):
    ...
    def _renderGame(self, style, mode="view"):
        ...
        html += '<div id="clickableAreaGameCompleteFeedback' + \
            self.id + '" style="position: absolute; z-index: 3">'
        ...
        html += '<div id="clickableAreaPositiveFeedback' + \
            self.id + '" style="position: absolute; z-index: 1">'
        ...
        html += '<div id="clickableAreaNegativeFeedback' + \
            self.id + '" style="position: absolute; z-index: 2">'
        ...
        html += """<div id="clickinorderstartarea%(gameId)s\" onclick="clickInOrderGame%(gameId)s.startGame()"
                style=\"width: %(width)spx; height: %(height)spx; position: absolute;\">""" % gameSizeArgs
        if previewMode:
    ...
    def renderEdit(self, style):
        ...
        html += "<br/>"
        html += common.submitButton("addClickableArea" +
                                    str(self.id), _("Add Clickable Area"))
        html += "<br/>"
...
class ClickInOrderClickableAreaElement(Element):
    ...
    def process(self, request):
        ...
        errMsg = field_engine_check_fields_are_ints(
            self.textElements, [
    ...
    def renderEdit(self):
        ...
        # for textAreaElementName, textAreaElement in
        # self.textAreaElements.iteritems():
