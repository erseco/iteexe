...
class MemoryMatchIdeviceInc(Idevice):
    ...
    def __init__(self, content=""):
        ...
        mainFieldOrder = [
            ...
            'cellbackImg',
            'revealedBackground',
            'positivefeedbackeffect',
            'negativefeedbackeffect',
            'useTimer',
            'timertext',
            'timerstyle',
            'hideAfterMatch',
            'hideAfterMatchEffect',
            'cellpadding',
            'cellspacing',
            'cellstyle']
        ...
        self.mainFieldSet = ExtendedFieldSet(
            self, mainFieldOrder, mainFieldsInfo)
    ...
    def upradeToVersion2(self):
        ...
        self.mainFieldSet.fieldInfoDict['title'] = [
            'text', x_('Title'), x_('Title')]
        self.mainFieldSet.makeFields()

    def upgradeToVersion3(self):
        self.mainFieldSet.fieldInfoDict['coverImg'][3] = {
            'defaultval': 'memmatch_covercelldefault.png'}
        self.mainFieldSet.fieldInfoDict['cellbackImg'][3] = {
            'defaultval': 'memmatch_showcelldefaultbg.png'}
...
class MemoryMatchPairField(Field):
    ...
    def __init__(
            self,
            idevice,
            desc=x_("Memory Match Pair Field"),
            help=x_("Memory Match Pair Field")):
        ...
        self.mainFields = ExtendedFieldSet(
            self.idevice, mainFieldOrder, mainFieldsInfo)
