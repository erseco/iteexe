...
class NotaBlock(Block):
    ...
    def renderEdit(self, style):
        ...
        html += '<p>' + \
            _("This iDevice will only be visible in eXe. It won't be exported.") + '</p>'
    ...
    def renderNote(self):
        ...
        if self.previewing:
            ...
            html += "<a title=\"" + _("Delete all notes") + "\" href=\"#\" onclick=\"confirmThenSubmitLink('" + _("Would you delete all notes?") + "', '" + 'deleteallnotes' + "', '" + self.id + \
                "', 1);\" style=\"float:right;margin-top:-20px;\"><img alt=\"" + _("Delete all notes") + "\" width=\"16\" height=\"16\" class=\"submit\" src=\"/images/stock-delete.png\"></a>"
        html += "</div>\n"
