...
from engine.field import ClozelangField, TextAreaField
...
click on the Hide/Show Word button below.</p><p>More than one possible answer can be defined enclosing them with pipes (|). I.e.: |dog|cat|bird|</p>""")
    ...
    def upgradeToVersion7(self):
        if self._title == "FPD - Actividad de Espacios en Blanco (Modificada)":
            self._title = "FPD - Cloze Activity (Modified)"
        if self._title == "Actividad de Espacios en Blanco (Modificada)":
